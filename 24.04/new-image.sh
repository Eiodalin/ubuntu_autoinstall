...
# Created for creating an easy auto-install ubuntu 24.04 noble
# Created by Colton Morey 
# Based off https://www.pugetsystems.com/labs/hpc/ubuntu-22-04-server-autoinstall-iso/ for reference
...
ubuntu_source='https://releases.ubuntu.com/noble/ubuntu-24.04.3-live-server-amd64.iso'
